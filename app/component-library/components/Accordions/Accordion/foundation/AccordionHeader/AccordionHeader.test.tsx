...
describe('AccordionHeader', () => {
  it('should render AccordionHeader', () => {
    ...
    const accordionHeaderComponent = getByTestId(TESTID_ACCORDIONHEADER);
  ...
  it('should render the given title', () => {
    ...
    const titleElement = getByTestId(TESTID_ACCORDIONHEADER_TITLE);
  ...
  it('should render the proper arrow down icon', () => {
    ...
    const iconElement = getByTestId(TESTID_ACCORDIONHEADER_ARROWICON);
